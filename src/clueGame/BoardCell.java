...
public class BoardCell {
	...
	public static final Color TARGET_FILL = Color.green;
	...
	public void draw(Graphics g) {
		if(Board.getInstance().getTargets() != null && Board.getInstance().getTargets().contains(this) && Board.getInstance().getCurrentPlayer() instanceof HumanPlayer) {
			drawCell(g, WALKWAY_OUTLINE, TARGET_FILL);
		}
		else {
			if (isWalkway()) {
